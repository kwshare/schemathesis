...
class BaseOpenAPISchema(BaseSchema):
    ...
    def get_stateful_tests(
        self, response: GenericResponse, endpoint: EndpointProtocol, stateful: Optional[str]
    ...
    def get_case_strategy(self, endpoint: EndpointProtocol, hooks: Optional[HookDispatcher] = None) -> SearchStrategy:
